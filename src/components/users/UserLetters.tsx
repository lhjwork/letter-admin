              ...
              <div key={letter._id} className="user-letters__item">
                ...
                <div className="user-letters__item-meta">
                  ...
                  <div className="user-letters__item-stats">
                    <span className="user-letters__item-stat">👁️ {formatNumber(letter.viewCount)}</span>
                    <span className="user-letters__item-stat">❤️ {formatNumber(letter.likeCount)}</span>
                  </div>
